...
ggplot(diagnosed, aes(infection, sex.bodycond, col=SEX))+geom_point()+geom_smooth(method='lm')
...
infection.Na <- data.frame(y = Sodium.omit$infection, n = nrow(Sodium.omit), x = Sodium.omit$Na)
