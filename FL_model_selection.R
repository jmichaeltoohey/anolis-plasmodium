#source("FL_bayesian_models.R")
##Running entire script above would take up excessive time and storage
##We suggest running one model set at a time
...
loglik.infection.sex..habitat <- mod.infection.sex..habitat$BUGSoutput$sims.list$LogLik
loglik.infection.site <- mod.infection.site$BUGSoutput$sims.list$LogLik
loglik.infection.site.sex <- mod.infection.site.sex$BUGSoutput$sims.list$LogLik
loglik.infection.site..sex <- mod.infection.site..sex$BUGSoutput$sims.list$LogLik
loglik.infection.site.habitat <- mod.infection.site.habitat$BUGSoutput$sims.list$LogLik
loglik.infection.site..habitat <- mod.infection.site..habitat$BUGSoutput$sims.list$LogLik
loglik.infection.sex.site.habitat <- mod.infection.sex.site.habitat$BUGSoutput$sims.list$LogLik
loglik.infection.sex..site..habitat <- mod.infection.sex..site..habitat$BUGSoutput$sims.list$LogLik
...
waic.infection.sex..habitat <- waic(loglik.infection.sex..habitat)
waic.infection.site <- waic(loglik.infection.site)
waic.infection.site.sex <- waic(loglik.infection.site.sex)
waic.infection.site..sex <- waic(loglik.infection.site..sex)
waic.infection.site.habitat <- waic(loglik.infection.site.habitat)
waic.infection.site..habitat <- waic(loglik.infection.site..habitat)
waic.infection.sex.site.habitat <- waic(loglik.infection.sex.site.habitat)
waic.infection.sex..site..habitat <- waic(loglik.infection.sex..site..habitat)

#Order wAIC in list to compare
infection.list <- list(waic.infection.null, #1
                       waic.infection.svl, waic.infection.sex, waic.infection.habitat, #2, 3, 4
                       waic.infection.svl.habitat, waic.infection.svl..habitat, #5, 6
                       waic.infection.sex.habitat, waic.infection.sex..habitat, #7, 8
                       waic.infection.site, #9
                       waic.infection.site.sex, waic.infection.site..sex, #10, 11
                       waic.infection.site.habitat, waic.infection.site..habitat, #12, 13
                       waic.infection.sex.site.habitat, waic.infection.sex..site..habitat) #14, 15
...
infection_names <- c("p(infection) ~ (SVL*Habitat)", 
                     "p(infection) ~ SVL + Habitat", 
                     "p(infection) ~ (Sex*Habitat)", 
                     "p(infection) ~ Sex + Habitat",
                     "p(infection) ~ Habitat", 
                     "p(infection) ~ SVL",
                     "p(infection) ~ Sex + Habitat + Site",
...
weights.infection <- data.frame(length=length(infection.list))
sums=0
...
#Calculate weights of top models ([DELTA]wAIC < 2)
weights.infection <- data.frame(length=2) #two strong models
sums=0
for(i in 1:2){
  sums <- sums+ exp(0.5*(infection.compare[1,7]-infection.compare[i,7]))
}
...
loglik.M.bodycond.site <- mod.male.bodycond.site$BUGSoutput$sims.list$LogLik
loglik.M.bodycond.infection <- mod.male.bodycond.infection$BUGSoutput$sims.list$LogLik
loglik.M.bodycond.habitat.site <- mod.male.bodycond.habitat.site$BUGSoutput$sims.list$LogLik
loglik.M.bodycond.habitat..site <- mod.male.bodycond.habitat..site$BUGSoutput$sims.list$LogLik
loglik.M.bodycond.infection.habitat <- mod.male.bodycond.infection.habitat$BUGSoutput$sims.list$LogLik
loglik.M.bodycond.infection.site <- mod.male.bodycond.infection.site$BUGSoutput$sims.list$LogLik
loglik.M.bodycond.infection.habitat.site <- mod.male.bodycond.infection.habitat.site$BUGSoutput$sims.list$LogLik
loglik.M.bodycond.infection.habitat..site <- mod.male.bodycond.infection.habitat..site$BUGSoutput$sims.list$LogLik

#Extract wAIC for each model
waic.M.bodycond.null <- waic(loglik.M.bodycond.null)
waic.M.bodycond.habitat <- waic(loglik.M.bodycond.habitat)
waic.M.bodycond.site <- waic(loglik.M.bodycond.site)
waic.M.bodycond.infection <- waic(loglik.M.bodycond.infection)
waic.M.bodycond.habitat.site <- waic(loglik.M.bodycond.habitat.site)
waic.M.bodycond.habitat..site <- waic(loglik.M.bodycond.habitat..site)
waic.M.bodycond.infection.habitat <- waic(loglik.M.bodycond.infection.habitat)
waic.M.bodycond.infection.site <- waic(loglik.M.bodycond.infection.site)
waic.M.bodycond.infection.habitat.site <- waic(loglik.M.bodycond.infection.habitat.site)
waic.M.bodycond.infection.habitat..site <- waic(loglik.M.bodycond.infection.habitat..site)

#Order wAIC in list to compare
M.bodycond.list <- list(waic.M.bodycond.null,
                        waic.M.bodycond.habitat,
                        waic.M.bodycond.site,
                        waic.M.bodycond.infection,
                        waic.M.bodycond.habitat.site,
                        waic.M.bodycond.habitat..site,
                        waic.M.bodycond.infection.habitat,
                        waic.M.bodycond.infection.site,
                        waic.M.bodycond.infection.habitat.site,
                        waic.M.bodycond.infection.habitat..site)
...
#Given names for clarity
#Done manually by comparing numbered output of loo_compare() to the order of models in the list
M_bodycond_names <- c("M Body Condition ~ Infection",
                      "M Body Condition ~ Infection + Habitat",
                      "M Body Condition ~ 1",
                      "M Body Condition ~ Infection + (Habitat*Site)",
                      "M Body Condition ~ Habitat",
                      "M Body Condition ~ (Habitat*Site)",
                      "M Body Condition ~ Infection + Habitat + Site",
                      "M Body Condition ~ Infection + Site",
                      "M Body Condition ~ Site",
                      "M Body Condition ~ Habitat + Site")
...
#Calculate wAIC weights for each model in set
weights.M.bodycond <- data.frame(length=10)
sums=0
...
loglik.Hct.sex..habitat <- mod.Hct.sex..habitat$BUGSoutput$sims.list$LogLik
loglik.Hct.site <- mod.Hct.site$BUGSoutput$sims.list$LogLik
loglik.Hct.site.sex <- mod.Hct.site.sex$BUGSoutput$sims.list$LogLik
loglik.Hct.site..sex <- mod.Hct.site..sex$BUGSoutput$sims.list$LogLik
loglik.Hct.site.habitat <- mod.Hct.site.habitat$BUGSoutput$sims.list$LogLik
loglik.Hct.site..habitat <- mod.Hct.site..habitat$BUGSoutput$sims.list$LogLik
loglik.Hct.sex.site.habitat <- mod.Hct.sex.site.habitat$BUGSoutput$sims.list$LogLik
loglik.Hct.sex..site..habitat <- mod.Hct.sex..site..habitat$BUGSoutput$sims.list$LogLik
...
loglik.Hct.infection.sex..habitat <- mod.Hct.infection.sex..habitat$BUGSoutput$sims.list$LogLik
loglik.Hct.infection.site <- mod.Hct.infection.site$BUGSoutput$sims.list$LogLik
loglik.Hct.infection.site.sex <- mod.Hct.infection.site.sex$BUGSoutput$sims.list$LogLik
loglik.Hct.infection.site..sex <- mod.Hct.infection.site..sex$BUGSoutput$sims.list$LogLik
loglik.Hct.infection.site.habitat <- mod.Hct.infection.site.habitat$BUGSoutput$sims.list$LogLik
loglik.Hct.infection.site..habitat <- mod.Hct.infection.site..habitat$BUGSoutput$sims.list$LogLik
loglik.Hct.infection.sex.site.habitat <- mod.Hct.infection.sex.site.habitat$BUGSoutput$sims.list$LogLik
loglik.Hct.infection.sex..site..habitat <- mod.Hct.infection.sex..site..habitat$BUGSoutput$sims.list$LogLik
...
waic.Hct.sex..habitat <- waic(loglik.Hct.sex..habitat)
waic.Hct.site <- waic(loglik.Hct.site)
waic.Hct.site.sex <- waic(loglik.Hct.site.sex)
waic.Hct.site..sex <- waic(loglik.Hct.site..sex)
waic.Hct.site.habitat <- waic(loglik.Hct.site.habitat)
waic.Hct.site..habitat <- waic(loglik.Hct.site..habitat)
waic.Hct.sex.site.habitat <- waic(loglik.Hct.sex.site.habitat)
waic.Hct.sex..site..habitat <- waic(loglik.Hct.sex..site..habitat)
...
waic.Hct.infection.sex..habitat <- waic(loglik.Hct.infection.sex..habitat)
waic.Hct.infection.site <- waic(loglik.Hct.infection.site)
waic.Hct.infection.site.sex <- waic(loglik.Hct.infection.site.sex)
waic.Hct.infection.site..sex <- waic(loglik.Hct.infection.site..sex)
waic.Hct.infection.site.habitat <- waic(loglik.Hct.infection.site.habitat)
waic.Hct.infection.site..habitat <- waic(loglik.Hct.infection.site..habitat)
waic.Hct.infection.sex.site.habitat <- waic(loglik.Hct.infection.sex.site.habitat)
waic.Hct.infection.sex..site..habitat <- waic(loglik.Hct.infection.sex..site..habitat)

#Order wAIC in list to compare
Hct.list <- list(waic.Hct.null, #1
                 waic.Hct.svl, waic.Hct.sex, waic.Hct.habitat, #2, 3, 4
                 waic.Hct.svl.habitat, waic.Hct.svl..habitat, #5, 6
                 waic.Hct.sex.habitat, waic.Hct.sex..habitat, #7, 8
                 waic.Hct.site, #9
                 waic.Hct.site.sex, waic.Hct.site..sex, #10, 11
                 waic.Hct.site.habitat, waic.Hct.site..habitat, #12, 13
                 waic.Hct.sex.site.habitat, waic.Hct.sex..site..habitat, #14, 15
                 waic.Hct.infection, #16
                 waic.Hct.infection.svl, waic.Hct.infection.sex, waic.Hct.infection.habitat, #17, 18, 19
                 waic.Hct.infection.svl.habitat, waic.Hct.infection.svl..habitat, #20, 21
                 waic.Hct.infection.sex.habitat, waic.Hct.infection.sex..habitat, #22, 23
                 waic.Hct.infection.site, #24
                 waic.Hct.infection.site.sex, waic.Hct.infection.site..sex, #25, 26
                 waic.Hct.infection.site.habitat, waic.Hct.infection.site..habitat, #27, 28
                 waic.Hct.infection.sex.site.habitat, waic.Hct.infection.sex..site..habitat) #29, 30
...
Hct_names <- c("Hct ~ 1",
               ...
               "Hct ~ (Habitat*Site)",
               "Hct ~ Sex + Habitat + Site",
               "Hct ~ Infection + (Habitat*Site)",
               "Hct ~ Infection + Sex + Habitat + Site",
               "Hct ~ (Sex*Site)",
               "Hct ~ Infection + (Sex*Site)",
               "Hct ~ Infection + (Sex*Habitat) + (Sex*Site) + (Habitat*Site)",
               "Hct ~ (Sex*Habitat) + (Sex*Site) + (Habitat*Site)")

rownames(Hct.compare) <- Hct_names
#print(Hct.compare, simplify=FALSE)

#Calculate wAIC weights for each model in set
weights.Hct <- data.frame(length=7)
sums=0
...
#Calculate weights of top models ([DELTA]wAIC < 2)
weights.Hct <- data.frame(length=6)
sums=0
for(i in 1:6){
  sums <- sums+ exp(0.5*(Hct.compare[1,7]-Hct.compare[i,7]))
}
...
loglik.PC1.sex..habitat <- mod.PC1.sex..habitat$BUGSoutput$sims.list$LogLik
loglik.PC1.site <- mod.PC1.site$BUGSoutput$sims.list$LogLik
loglik.PC1.site.sex <- mod.PC1.site.sex$BUGSoutput$sims.list$LogLik
loglik.PC1.site..sex <- mod.PC1.site..sex$BUGSoutput$sims.list$LogLik
loglik.PC1.site.habitat <- mod.PC1.site.habitat$BUGSoutput$sims.list$LogLik
loglik.PC1.site..habitat <- mod.PC1.site..habitat$BUGSoutput$sims.list$LogLik
loglik.PC1.sex.site.habitat <- mod.PC1.sex.site.habitat$BUGSoutput$sims.list$LogLik
loglik.PC1.sex..site..habitat <- mod.PC1.sex..site..habitat$BUGSoutput$sims.list$LogLik
...
loglik.PC1.infection.sex..habitat <- mod.PC1.infection.sex..habitat$BUGSoutput$sims.list$LogLik
loglik.PC1.infection.site <- mod.PC1.infection.site$BUGSoutput$sims.list$LogLik
loglik.PC1.infection.site.sex <- mod.PC1.infection.site.sex$BUGSoutput$sims.list$LogLik
loglik.PC1.infection.site..sex <- mod.PC1.infection.site..sex$BUGSoutput$sims.list$LogLik
loglik.PC1.infection.site.habitat <- mod.PC1.infection.site.habitat$BUGSoutput$sims.list$LogLik
loglik.PC1.infection.site..habitat <- mod.PC1.infection.site..habitat$BUGSoutput$sims.list$LogLik
loglik.PC1.infection.sex.site.habitat <- mod.PC1.infection.sex.site.habitat$BUGSoutput$sims.list$LogLik
loglik.PC1.infection.sex..site..habitat <- mod.PC1.infection.sex..site..habitat$BUGSoutput$sims.list$LogLik
...
waic.PC1.sex..habitat <- waic(loglik.PC1.sex..habitat)
waic.PC1.site <- waic(loglik.PC1.site)
waic.PC1.site.sex <- waic(loglik.PC1.site.sex)
waic.PC1.site..sex <- waic(loglik.PC1.site..sex)
waic.PC1.site.habitat <- waic(loglik.PC1.site.habitat)
waic.PC1.site..habitat <- waic(loglik.PC1.site..habitat)
waic.PC1.sex.site.habitat <- waic(loglik.PC1.sex.site.habitat)
waic.PC1.sex..site..habitat <- waic(loglik.PC1.sex..site..habitat)
...
waic.PC1.infection.sex..habitat <- waic(loglik.PC1.infection.sex..habitat)
waic.PC1.infection.site <- waic(loglik.PC1.infection.site)
waic.PC1.infection.site.sex <- waic(loglik.PC1.infection.site.sex)
waic.PC1.infection.site..sex <- waic(loglik.PC1.infection.site..sex)
waic.PC1.infection.site.habitat <- waic(loglik.PC1.infection.site.habitat)
waic.PC1.infection.site..habitat <- waic(loglik.PC1.infection.site..habitat)
waic.PC1.infection.sex.site.habitat <- waic(loglik.PC1.infection.sex.site.habitat)
waic.PC1.infection.sex..site..habitat <- waic(loglik.PC1.infection.sex..site..habitat)

#Order wAIC in list to compare
PC1.list <- list(waic.PC1.null, #1
                 waic.PC1.svl, waic.PC1.sex, waic.PC1.habitat, #2, 3, 4
                 waic.PC1.svl.habitat, waic.PC1.svl..habitat, #5, 6
                 waic.PC1.sex.habitat, waic.PC1.sex..habitat, #7, 8
                 waic.PC1.site, #9
                 waic.PC1.site.sex, waic.PC1.site..sex, #10, 11
                 waic.PC1.site.habitat, waic.PC1.site..habitat, #12, 13
                 waic.PC1.sex.site.habitat, waic.PC1.sex..site..habitat, #14, 15
                 waic.PC1.infection, #16
                 waic.PC1.infection.svl, waic.PC1.infection.sex, waic.PC1.infection.habitat, #17, 18, 19
                 waic.PC1.infection.svl.habitat, waic.PC1.infection.svl..habitat, #20, 21
                 waic.PC1.infection.sex.habitat, waic.PC1.infection.sex..habitat, #22, 23
                 waic.PC1.infection.site, #24
                 waic.PC1.infection.site.sex, waic.PC1.infection.site..sex, #25, 26
                 waic.PC1.infection.site.habitat, waic.PC1.infection.site..habitat, #27, 28
                 waic.PC1.infection.sex.site.habitat, waic.PC1.infection.sex..site..habitat) #29, 30
...
PC1_names <- c("PC1 ~ 1",  
               ...
               "PC1 ~ Sex + Habitat + Site",
               "PC1 ~ Infection + (Sex*Habitat)",
               "PC1 ~ (Habitat*Site)",
               "PC1 ~ Infection + Sex + Habitat + Site",
               "PC1 ~ Infection + (Habitat*Site)",
               "PC1 ~ (Sex*Habitat) + (Sex*Site) + (Habitat*Site)",
               "PC1 ~ Infection + (Sex*Habitat) + (Sex*Site) + (Habitat*Site)")

rownames(PC1.compare) <- PC1_names
#print(PC1.compare, simplify=FALSE)

#Calculate wAIC weights for each model in set
weights.PC1 <- data.frame(length=7)
sums=0
...
loglik.PC2.sex..habitat <- mod.PC2.sex..habitat$BUGSoutput$sims.list$LogLik
loglik.PC2.site <- mod.PC2.site$BUGSoutput$sims.list$LogLik
loglik.PC2.site.sex <- mod.PC2.site.sex$BUGSoutput$sims.list$LogLik
loglik.PC2.site..sex <- mod.PC2.site..sex$BUGSoutput$sims.list$LogLik
loglik.PC2.site.habitat <- mod.PC2.site.habitat$BUGSoutput$sims.list$LogLik
loglik.PC2.site..habitat <- mod.PC2.site..habitat$BUGSoutput$sims.list$LogLik
loglik.PC2.sex.site.habitat <- mod.PC2.sex.site.habitat$BUGSoutput$sims.list$LogLik
loglik.PC2.sex..site..habitat <- mod.PC2.sex..site..habitat$BUGSoutput$sims.list$LogLik
...
loglik.PC2.infection.sex..habitat <- mod.PC2.infection.sex..habitat$BUGSoutput$sims.list$LogLik
loglik.PC2.infection.site <- mod.PC2.infection.site$BUGSoutput$sims.list$LogLik
loglik.PC2.infection.site.sex <- mod.PC2.infection.site.sex$BUGSoutput$sims.list$LogLik
loglik.PC2.infection.site..sex <- mod.PC2.infection.site..sex$BUGSoutput$sims.list$LogLik
loglik.PC2.infection.site.habitat <- mod.PC2.infection.site.habitat$BUGSoutput$sims.list$LogLik
loglik.PC2.infection.site..habitat <- mod.PC2.infection.site..habitat$BUGSoutput$sims.list$LogLik
loglik.PC2.infection.sex.site.habitat <- mod.PC2.infection.sex.site.habitat$BUGSoutput$sims.list$LogLik
loglik.PC2.infection.sex..site..habitat <- mod.PC2.infection.sex..site..habitat$BUGSoutput$sims.list$LogLik
...
waic.PC2.sex..habitat <- waic(loglik.PC2.sex..habitat)
waic.PC2.site <- waic(loglik.PC2.site)
waic.PC2.site.sex <- waic(loglik.PC2.site.sex)
waic.PC2.site..sex <- waic(loglik.PC2.site..sex)
waic.PC2.site.habitat <- waic(loglik.PC2.site.habitat)
waic.PC2.site..habitat <- waic(loglik.PC2.site..habitat)
waic.PC2.sex.site.habitat <- waic(loglik.PC2.sex.site.habitat)
waic.PC2.sex..site..habitat <- waic(loglik.PC2.sex..site..habitat)
...
waic.PC2.infection.sex..habitat <- waic(loglik.PC2.infection.sex..habitat)
waic.PC2.infection.site <- waic(loglik.PC2.infection.site)
waic.PC2.infection.site.sex <- waic(loglik.PC2.infection.site.sex)
waic.PC2.infection.site..sex <- waic(loglik.PC2.infection.site..sex)
waic.PC2.infection.site.habitat <- waic(loglik.PC2.infection.site.habitat)
waic.PC2.infection.site..habitat <- waic(loglik.PC2.infection.site..habitat)
waic.PC2.infection.sex.site.habitat <- waic(loglik.PC2.infection.sex.site.habitat)
waic.PC2.infection.sex..site..habitat <- waic(loglik.PC2.infection.sex..site..habitat)

#Order wAIC in list to compare
PC2.list <- list(waic.PC2.null, #1
                 waic.PC2.svl, waic.PC2.sex, waic.PC2.habitat, #2, 3, 4
                 waic.PC2.svl.habitat, waic.PC2.svl..habitat, #5, 6
                 waic.PC2.sex.habitat, waic.PC2.sex..habitat, #7, 8
                 waic.PC2.site, #9
                 waic.PC2.site.sex, waic.PC2.site..sex, #10, 11
                 waic.PC2.site.habitat, waic.PC2.site..habitat, #12, 13
                 waic.PC2.sex.site.habitat, waic.PC2.sex..site..habitat, #14, 15
                 waic.PC2.infection, #16
                 waic.PC2.infection.svl, waic.PC2.infection.sex, waic.PC2.infection.habitat, #17, 18, 19
                 waic.PC2.infection.svl.habitat, waic.PC2.infection.svl..habitat, #20, 21
                 waic.PC2.infection.sex.habitat, waic.PC2.infection.sex..habitat, #22, 23
                 waic.PC2.infection.site, #24
                 waic.PC2.infection.site.sex, waic.PC2.infection.site..sex, #25, 26
                 waic.PC2.infection.site.habitat, waic.PC2.infection.site..habitat, #27, 28
                 waic.PC2.infection.sex.site.habitat, waic.PC2.infection.sex..site..habitat) #29, 30
...
PC2_names <- c("PC2 ~ Infection",
               ...
               "PC2 ~ Sex + Habitat + Site",
               "PC2 ~ (Sex*Site)", 
               "PC2 ~ (Habitat*Site)",
               "PC2 ~ Infection + (Habitat*Site)",
               "PC2 ~ Infection + Sex + Habitat + Site",
               "PC2 ~ Infection + (Sex*Site)",
               "PC2 ~ (Sex*Habitat) + (Sex*Site) + (Habitat*Site)",
               "PC2 ~ Infection + (Sex*Habitat) + (Sex*Site) + (Habitat*Site)")

rownames(PC2.compare) <- PC2_names
#print(PC2.compare, simplify=FALSE)

#Calculate wAIC weights for each model in set
weights.PC2 <- data.frame(length=12)
sums=0
